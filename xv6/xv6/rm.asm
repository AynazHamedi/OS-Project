...
00000300 <printint>:
 ...
 334:	8a 92 64 07 00 00    	mov    0x764(%edx),%dl
...
0000038c <printf>:
 ...
 3e9:	ff 24 85 0c 07 00 00 	jmp    *0x70c(,%eax,4)
 ...
 4f6:	ba 05 07 00 00       	mov    $0x705,%edx
...
00000504 <free>:
 ...
 529:	a1 cc 07 00 00       	mov    0x7cc,%eax
 ...
 555:	89 15 cc 07 00 00    	mov    %edx,0x7cc
...
000005b4 <malloc>:
 ...
 5eb:	47                   	inc    %edi
 5ec:	8b 15 cc 07 00 00    	mov    0x7cc,%edx
 ...
 627:	39 05 cc 07 00 00    	cmp    %eax,0x7cc
 ...
 64f:	8b 15 cc 07 00 00    	mov    0x7cc,%edx
 ...
 677:	89 15 cc 07 00 00    	mov    %edx,0x7cc
 ...
 68f:	90                   	nop
 690:	c7 05 cc 07 00 00 d0 	movl   $0x7d0,0x7cc
 697:	07 00 00 
 69a:	c7 05 d0 07 00 00 d0 	movl   $0x7d0,0x7d0
 6a1:	07 00 00 
 6a4:	c7 05 d4 07 00 00 00 	movl   $0x0,0x7d4
 6ab:	00 00 00 
 6ae:	b8 d0 07 00 00       	mov    $0x7d0,%eax
